...
public class Prostori
{
    ...
    public string Dodjelio { get => _Dodjelio; set => _Dodjelio = value; }
    public DateTime? DodjeljenoDo { get => _DodjeljenoDo; set => _DodjeljenoDo = value; }

    public Prostori(int id, int idUdruge, string Adresa, string Namjena, string Dodjelio, DateTime? DodjeljenoDo)
    {
        ...
        if (string.IsNullOrEmpty(Dodjelio))
        {
            throw new ArgumentException($"'{nameof(Dodjelio)}' cannot be null or empty.", nameof(Dodjelio));
        }
    ...
    public override bool Equals(object? obj)
    {
        return  obj is not null &&
               ...
               _Dodjelio == Prostori._Dodjelio &&
               _DodjeljenoDo == Prostori._DodjeljenoDo
    }

    public override int GetHashCode()
    {
        return HashCode.Combine(_Id,_IdUdruge, _Adresa, _Namjena, _Dodjelio, _DodjeljenoDo);
    }
    ...
    public override Result IsValid()
        => Validation.Validate(
            ...
            (() => _Dodjelio.Length <= 50, "Dodjelio lenght must be less than 50 characters"),
